...
// // Kişiselleştirme analitikleri
// router.get('/analytics/personalization', authMiddleware, async (req, res) => {
//   try {
//     const userId = req.userId;
//     const profile = await userLearningService.getOrCreateUserProfile(userId);
    
//     // Kişiselleştirme etkisini hesapla
//     const analytics = {
//       profileMaturity: profile.autoGenerated.profileCompleteness,
//       learningProgress: {
//         topicsExplored: profile.interests.primaryTopics.length,
//         averageTechnicalLevel: Object.values(profile.interests.technicalLevel).reduce((a, b) => a + b, 0) / 3,
//         goalsSet: profile.learningProgress.goals.length,
//         goalsAchieved: profile.learningProgress.goals.filter(g => g.isAchieved).length
//       },
//       communicationInsights: {
//         preferredStyle: profile.personality.communicationStyle,
//         responsePreference: profile.personality.responsePreference,
//         averageMessageLength: profile.conversationPatterns.averageMessageLength,
//         helpfulnessRate: profile.feedbackPatterns.helpfulnessRate
//       },
//       usagePatterns: {
//         totalSessions: profile.statistics.totalSessions,
//         averageSessionLength: profile.conversationPatterns.timePatterns.sessionDuration,
//         mostActiveHours: profile.conversationPatterns.timePatterns.mostActiveHours
//       }
//     };
    
//     res.json({
//       message: 'Kişiselleştirme analitikleri alındı',
//       analytics
//     });
//   } catch (error) {
//     console.error('Analitik hatası:', error);
//     res.status(500).json({ message: 'Analitikler alınamadı', error: error.message });
//   }
// });
